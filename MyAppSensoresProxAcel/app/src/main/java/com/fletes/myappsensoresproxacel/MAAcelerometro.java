...
public class MAAcelerometro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maacelerometro);
    ...
    private void sonido(){
        MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.ic_laser);
        mediaPlayer.start();
    }
